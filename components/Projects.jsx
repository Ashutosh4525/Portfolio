...
const projects = [
  ...
  },
  {
    ...
    tech: ['MongoDB', 'Express.js', 'React.js', 'Node.js', 'JWT', 'OpenAI','Multer'],
    live: 'https://streamforge-psi.vercel.app/',
    github: 'https://github.com/Ashutosh4525/Mern_Fullstack',
  },
  {
    name: 'Full-Stack Book Management System',
    status: 'Live',
    summary: 'A Role-Based Access Control (RBAC) to distinguish between Admin and User permissions, securing sensitive CRUD operations and administrative dashboards. ',
    recruiterAngle: 'Demonstrates multi-role flows, JWT auth, Integrated Multer for multi-part form data processing',
    highlights: ['Role-Based Access Control (RBAC)', 'JWT authentication', 'Full MERN architecture'],
    tech: ['MongoDB', 'Express.js', 'Vercel','Render','Multer', 'Node.js', 'JWT'],
    live: 'https://mern-fullstack-dun.vercel.app/',
    github: 'https://github.com/Ashutosh4525/Mern_Fullstack',
  },
  {
    name: 'Sports Team Frontend Interface ',
    status: 'Live',
    summary: 'A sports team interface utilizing Redux with UI/UX',
    recruiterAngle: 'Engineered a scalable state management architecture with Redux Toolkit, utilizing a centralized store to maintain "source of truth" for player data and team statistics. ',
    highlights: ['Redux Slices','Mobile Responsiveness', 'UI/UX'],
    tech: [ 'React.js', 'Redux Toolkit', 'React Router', 'CSS3', 'Netlify' ],
    live: 'https://resonant-muffin-6ef1af.netlify.app/',
    github: 'https://github.com/Ashutosh4525/Mern_Fullstack',
  },
  {
    ...
    live: 'https://portfolio-one-vert-99.vercel.app/',
    github: 'https://github.com/Ashutosh4525/Portfolio'
  },
];
